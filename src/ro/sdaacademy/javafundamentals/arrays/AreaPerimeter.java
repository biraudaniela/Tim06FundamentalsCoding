...
5. Create 2 methods
    ...
    In the methods above the figure is the type of figure (cerc,patrat,triunghi) a
    nd parameter is the in case needed parameter.

    Ex cerc neede raza, patrat needes latura and triughi needs latura in order to calculate
    the area and perimeter.
6. Using the 2 methids from point 5 display the values to the user.
Please format the value using printf: only display 2 decimals.
